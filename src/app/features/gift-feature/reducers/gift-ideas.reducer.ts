...
//   ids: ['1', '2'],
//   entities: {
//     1: { id: '1', for: 'Justin', holiday: 'Christmas', suggestions: 'idk' },
//     2: { id: '2', for: 'Fren', holiday: 'Christmas', suggestions: 'games' },
//   }
// }
...
const reducerFunction = createReducer(
  ...
  on(actions.loadGiftDataSuccess, (state, action) => adapter.setAll(action.payload, state)),
  on(actions.giftAddedSuccess, (state, action) => {
